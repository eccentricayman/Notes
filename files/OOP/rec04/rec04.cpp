...
// somehow the while's test has to fail - from keyboard input
   ...
   void vibrateSpeakerCones(unsigned signal) const {
	...
	const SpeakerSystem* ss = new SpeakerSystem;
	...
	public:       
		...
		void movesInWith(Person& newRoomate) {
			//i got no roomate
			if (!roomie) {
				//new guy has no roomie
				if (!newRoomate.roomie) {
					roomie = &newRoomate;        // now I have a new room  
					newRoomate.roomie = this;    // and now they do too
				}
				//new guy has roomie
				else {
					if (newRoomate.roomie == this) {
						cout << "You're already their roommate" << endl;
					}
					else {
						cout << "Dude got a roommate already..." << endl;
					}
				}
			}
			//new roomie is self
			else if (this == &newRoomate) {
				cout << "cant move in with urself lonely bum" << endl;
			}
			//i have roommate
			else {
				cout << "You got a roommate chill" << endl;
			}
		}       
